...
Porém minha intenção é utilizar o recurso através de biblioteca, passando por parametro na inicialização as funções que rodarão em loop no Core 0 e no Core 1.
